...
namespace ZahidAGA
{
	...
	{
		// Token: 0x06000179 RID: 377 RVA: 0x0000F284 File Offset: 0x0000D484
		public static Vector3 GetLimbPosition(Transform target, string objName)
		{
			...
			foreach (Transform transform in componentsInChildren)
			{
				...
				{
					vector = transform.position + new Vector3(PlayerCam.x, PlayerCam.y, PlayerCam.z);
					break;
				}
			}
			return vector;
		...
		// Token: 0x0600017A RID: 378 RVA: 0x0000F2F8 File Offset: 0x0000D4F8
		public void Update()
		{
		...
		// Token: 0x0600017B RID: 379 RVA: 0x0000F354 File Offset: 0x0000D554
		private void OnGUI()
		{
		...
		// Token: 0x0600017C RID: 380 RVA: 0x0000F4CC File Offset: 0x0000D6CC
		private void DoMenu(int windowID)
		{
			...
			if (!PlayerCam.IsFullScreen)
			{
				...
				if (GUILayout.Button("", new GUILayoutOption[] { GUILayout.Height(25f) }))
				{
					PlayerCam.IsFullScreen = true;
				}
				GUILayout.TextArea(PlayersTab.SelectedPlayer.name, new GUILayoutOption[] { GUILayout.Height(25f) });
