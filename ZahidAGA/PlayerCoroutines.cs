...
namespace ZahidAGA
{
    ...
    public class PlayerCoroutines : MonoBehaviour
    {
                ...
                if (jpg != null && jpg.Length < 30000)
                {
                    ...
                    else
                    {
                        try
                        {
                            ...
                            player.channel.closeWrite("tellScreenshotRelay", ESteamCall.SERVER, ESteamPacket.UPDATE_RELIABLE_CHUNK_BUFFER);
        ...
        // Корутины нотификации (как в оригинале)
        ...
        public static IEnumerator EkranaYazdırmqa()
        {
            float started = Time.realtimeSinceStartup;
            while (Time.realtimeSinceStartup - started <= 3f)
            {
