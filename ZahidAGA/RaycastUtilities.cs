...
namespace ZahidAGA
{
	...
	public static class RaycastUtilities
	{
		...
		public static bool NoShootthroughthewalls(Transform transform)
		{
			...
			return Physics.Raycast(new Ray(Player.player.look.aim.position, vector), out raycastHit, vector.magnitude, RayMasks.DAMAGE_CLIENT, QueryTriggerInteraction.UseGlobal) && raycastHit.transform.IsChildOf(transform);
		}
